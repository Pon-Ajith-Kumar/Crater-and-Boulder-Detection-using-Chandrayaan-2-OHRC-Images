...
# Configuration
image_folder = '/content/drive/MyDrive/OHRC-ISRO/data_processed/images'
mask_folder = '/content/drive/MyDrive/OHRC-ISRO/data_processed/masks'
output_folder = '/content/drive/MyDrive/OHRC-ISRO/dataset/'
expected_width = 1200
...
if not image_files:
    print("No image files found in the specified folder or no corresponding mask files were found.")
else:
    # Split the dataset
